    ...
    return (
        <Layout>
            <div className="max-w-4xl mx-auto">
                <h1 className="text-4xl font-handwriting text-center mb-12">Contact Us</h1>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    {/* Contact Information */}
                    <div className="bg-white rounded-lg shadow-md p-6">
                        <h2 className="text-2xl font-handwriting mb-6">Get in Touch</h2>
                        <div className="space-y-4">
                            <div>
                                <h3 className="font-medium text-[#4A3C31]">Address</h3>
                                <p className="text-gray-600">123 Coffee Street</p>
                                <p className="text-gray-600">City, State 12345</p>
                            </div>
                            <div>
                                <h3 className="font-medium text-[#4A3C31]">Phone</h3>
                                <p className="text-gray-600">(555) 123-4567</p>
                            </div>
                            <div>
                                <h3 className="font-medium text-[#4A3C31]">Email</h3>
                                <p className="text-gray-600">hello@beanandbloom.com</p>
                            </div>
                            <div>
                                <h3 className="font-medium text-[#4A3C31]">Hours</h3>
                    ...
                    {/* Contact Form */}
                    <div className="bg-white rounded-lg shadow-md p-6">
                        <h2 className="text-2xl font-handwriting mb-6">Send us a Message</h2>
                ...
                <div className="mt-12 bg-white rounded-lg shadow-md p-6">
                    <h2 className="text-2xl font-handwriting mb-6">Find Us</h2>
